...
<div class="page-header">
    ...
    <p>View details of this approved thesis.</p>
</div>
    ...
    <div class="col-md-8" style="flex: 0 0 66.666%; padding: 0 15px;">
        <div class="card fade-in">
            ...
            <div class="card-body" style="padding: 25px;">
                ...
                <div class="detail-row" style="margin-bottom: 20px;">
                    <label style="font-weight: 600; display: block; margin-bottom: 5px;">Author:</label>
                    <p style="margin: 0;"><?php echo htmlspecialchars($thesis['author_first_name'] . ' ' . $thesis['author_last_name']); ?></p>
                </div>
                
                <div class="detail-row" style="margin-bottom: 20px;">
                    <label style="font-weight: 600; display: block; margin-bottom: 5px;">Adviser:</label>
                ...
                <div class="detail-row" style="margin-bottom: 20px;">
                    ...
                    <p style="margin: 0;"><?php echo date('F j, Y', strtotime($thesis['approved_at'])); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card fade-in">
            ...
            <div class="card-body" style="padding: 25px;">
                ...
                <?php if (count($reviews) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No reviews or comments available for this thesis.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
